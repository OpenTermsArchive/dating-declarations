...
The code in this repository is distributed under the GNU Affero General Public Licence (AGPL) v3.0. You need attribute the resulting works to Open Terms Archive with contributions from HestiaLabs for the Dating Privacy collective.
